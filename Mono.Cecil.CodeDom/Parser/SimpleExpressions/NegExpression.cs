...
{
	public sealed class NegExpression : CodeDomSingleInstructionExpression
	{
		public const int ValuePos = 0;
		public const int MaxNodes = 1;

		public NegExpression(Context context, Instruction position, CodeDomExpression exp_value)
...
namespace Mono.Cecil.CodeDom.Parser
{
	...
	{
		public static NegExpression Neg(Context context, Instruction position, CodeDomExpression exp_value)
		{
			return new NegExpression(context, position, exp_value);
		}
	}
}