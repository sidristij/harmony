...
{
	public sealed class FieldSetRefExpression : CodeDomSingleInstructionExpression, ICodeDomStaticInstance
	{
		public const int InstancePos = 0;
		public const int ValuePos = 1;
		public const int MaxNodes = 2;

		public FieldSetRefExpression(Context context, Instruction position, FieldReference ref_field, CodeDomExpression exp_value)
			: this(context, position, ref_field, exp_value, new CodeDomExpression(context))
		{
		}

		public FieldSetRefExpression(Context context, Instruction position, FieldReference ref_field, CodeDomExpression exp_value, CodeDomExpression exp_instance)
...
namespace Mono.Cecil.CodeDom.Parser
{
	...
	{
		public static FieldSetRefExpression FieldSetRef(Context context, Instruction position, FieldReference ref_field, CodeDomExpression exp_value, CodeDomExpression exp_instance = null)
		{
